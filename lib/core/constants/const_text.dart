const String welcomeDesText = "We're Glad To Have You Back Log In";
const String newPassText =
    "Your New Password Must Be Different From Previously Used Password";
const String signupDesText =
...
const String historyThree = "grown into a successful and well-respected organization";
const String productOne = "product a: high-quality and durable";
const String productTwo = "product b: easy to use and customize";
const String productThree = "product c: energy efficient and environmentally friendly";
const String awardOne = "best product award 2020";
const String awardTwo = "innovation of the year 2021";
const String awardThree = "customer satisfaction award 2022";
